...
/** Standard logging mode (no errors) */
	...
	/** Enable warning logs */
	#define S_LOG_WARNING(Category, Format, ...) LOG_BODY(Category, S_LOGLEVEL_WARNING, Format, __VA_ARGS__)

	/** Enable error logs */
	#define S_LOG_ERROR(Category, Format, ...) LOG_BODY(Category, S_LOGLEVEL_ERROR, Format, __VA_ARGS__)	
